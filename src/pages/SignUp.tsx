      ...
      <div style={pageStyle}>
        <Card>
          ...
          <form onSubmit={handleSubmit} style={formStyle}>
            ...
            <div style={passwordFieldStyle}>
              <Input label="Confirm Password" type={showConfirmPassword ? 'text' : 'password'} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="••••••••" required />
              <button type="button" style={toggleStyle} onClick={() => setShowConfirmPassword((visible) => !visible)} aria-pressed={showConfirmPassword}>
          ...
          <div style={footerStyle}>
            <p>Already have an account? <button type="button" style={linkStyle} onClick={onLogin}>Sign in</button></p>
          </div>
        </Card>
      </div>
    </Container>
